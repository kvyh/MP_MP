...
def play_game(board_state, current_dict, previous_moves, success_list):
    ...
    for move in mv:
        ...
        play_game(cur_stones, current_dict[move], moves_list, success_list)
...
if __name__ == "__main__":
    ...
    if not args.memory_limited:
        ...
        for start in unique_starts:
            ...
            play_game(starting_stones, Moves_dict[start], [start], complete_games)
        ...
        for start in unique_starts:
            ...
            play_game_limited(starting_stones, [start], complete_games, args.max_listed)
